...
import Styles from '@/Styles/brand-cat.module.css'
...
export default function Home() {
  return (
    <>
        ...
        <section className={`${Styles.brand_cat_wrapper} mt-5`} >
            <div className={`${Styles.brand_cat_container}`} >
                <h1 className="text-white font-weight-bold py-5">BABY <br/> FOODS</h1>
            </div>
        </section>
